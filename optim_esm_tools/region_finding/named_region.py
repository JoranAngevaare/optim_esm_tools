...
class NamedRegions(RegionExtractor):
    ...
    select_regions = 'S.W.South-America', 'W.North-America', 'N.Central-America', 'Mediterranean', 'S.Australia', 'W.Southern-Africa', 'E.Southern-Africa'
...
class Asia(NamedRegions):
    select_regions = ('Russian-Far-East', 'E.Asia', 'S.E.Asia', 'N.Australia')