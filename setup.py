...
setuptools.setup(
    name='optism_esm_tools',
    version='0.0.0',
    description='Tools for OptismESM',
    long_description=readme + '\n\n' + history,
    long_description_content_type='text/markdown',
    author='Joran R. Angevaare',
    url='https://github.com/JoranAngevaare/OptimESMPlayGround',
    packages=setuptools.find_packages() + ['extra_requirements'],
    package_dir={'optism_esm_tools': 'optism_esm_tools',
                 'extra_requirements': 'extra_requirements'},
    package_data={'optism_esm_tools': ['data/*'],
